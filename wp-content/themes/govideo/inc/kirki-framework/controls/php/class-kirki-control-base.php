	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'govideo' ),
				'remove'               => esc_attr__( 'Remove', 'govideo' ),
				'default'              => esc_attr__( 'Default', 'govideo' ),
				'selectFile'           => esc_attr__( 'Select File', 'govideo' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'govideo' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'govideo' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'govideo' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'govideo' ),
			)
		);
