...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'govideo' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'govideo' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'govideo' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'govideo' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'govideo' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'govideo' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'govideo' ); ?>',
		} );
		#>
		<label>
