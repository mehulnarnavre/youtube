...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'govideo' ),
				'change'       => esc_attr__( 'Change image', 'govideo' ),
				'default'      => esc_attr__( 'Default', 'govideo' ),
				'remove'       => esc_attr__( 'Remove', 'govideo' ),
				'placeholder'  => esc_attr__( 'No image selected', 'govideo' ),
				'frame_title'  => esc_attr__( 'Select image', 'govideo' ),
				'frame_button' => esc_attr__( 'Choose image', 'govideo' ),
			)
		);
	}
