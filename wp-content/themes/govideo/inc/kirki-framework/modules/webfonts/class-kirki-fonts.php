...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'govideo' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'govideo' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'govideo' ),
			'200'       => esc_attr__( 'Light 200', 'govideo' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'govideo' ),
			'300'       => esc_attr__( 'Book 300', 'govideo' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'govideo' ),
			'400'       => esc_attr__( 'Normal 400', 'govideo' ),
			'regular'   => esc_attr__( 'Normal 400', 'govideo' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'govideo' ),
			'500'       => esc_attr__( 'Medium 500', 'govideo' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'govideo' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'govideo' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'govideo' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'govideo' ),
			'700'       => esc_attr__( 'Bold 700', 'govideo' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'govideo' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'govideo' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'govideo' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'govideo' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'govideo' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'govideo' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'govideo' ),
		);
	}
