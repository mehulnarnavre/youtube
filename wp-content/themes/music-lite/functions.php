...
/** Function music_lite_admin_notice_sale */
function music_lite_admin_notice_sale() {
	if ( ! PAnD::is_admin_notice_active( 'notice-music-lite-sale-forever' ) ) {
		return;
	}
	?>

	<div data-dismissible="notice-music-lite-sale-forever" class="notice updated is-dismissible">

		<h2 style="margin-bottom:0px;"><?php esc_html_e( 'Save BIG on all WordPress products and services this holiday season!', 'music-lite' ); ?></h2>
		<p><?php printf( wp_kses_post( 'Take advantage of this opportunity to <a href="%1$s" target="_blank">upgrade your theme</a> or purchase the popular <a href="%2$s" target="_blank">Builder Widgets Pro</a> page builder plugin at a discounted price!', 'music-lite' ), 'https://organicthemes.com/theme/music-theme/', 'https://organicthemes.com/builder/' ); ?></p>
		<p><a class="button button-primary" href="https://organicthemes.com/pricing/" target="_blank"><?php esc_html_e( 'Start Saving', 'music-lite' ); ?></a></p>
...
add_action( 'admin_notices', 'music_lite_admin_notice_sale', 10 );
